...
const REVIEWED_FIXTURE: DemoFixture = {
  ...
  case: {
    ...
    protectedText:
      '가상고객A님이 __FPG_CONTACT_0001__로 연락해 __FPG_ACCOUNT_0001__ 자동이체 오류와 처리 결과 안내를 요청했습니다. 직원은 내부 조회 후 처리 결과를 안내하겠다고 설명했습니다.',
  },
  mockResponse:
    '가상고객A는 __FPG_ACCOUNT_0001__ 자동이체 오류의 확인과 처리 결과 안내를 요청했습니다. 직원은 내부 조회 뒤 __FPG_CONTACT_0001__로 안내하기로 설명했습니다.',
  verifiedResult: [
  ...
  blockReason: {
    mutatedMarker: '__FPG_ACCOUNT_0001',
